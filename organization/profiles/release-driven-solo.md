...
- `master`: released/integrated source state
...
- `master`へのnormal integrationはcurrent release branchからのrelease PRだけ
...
- project-local only; commit CLI-generated `skills-lock.json`; do not hand-edit upstream-managed Skills
